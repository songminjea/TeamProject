...
<body topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0">
	...
	<div id="positionLayer">
		...
		<div>
			<form action="">
				<input type="text" id="search_keyword" name="keyword" value="${chatlist.keyword}"
			   placeholder="검색할 아이디를 입력" style="margin-top: 10px;"> 
			   <button type="submit" id="search_confirm">
	...
	$(document).ready(function(){
		$("#search_confirm").on("click", function(event){
			self.location = "${pageContext.request.contextPath}/${member.ID}/chatSearchList${chatPageMaker.makeQuery(1)}"
							+"&searchType="+$("select option:selected").val()
							+"&keyword="+encodeURIComponent($("#search_keyword").val());
		});
	});
	</script>
</body>
