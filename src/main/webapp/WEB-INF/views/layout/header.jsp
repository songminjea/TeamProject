...
<div class="top-bar" style="height: 70px;">
	<div class="container-fluid">
			<div class="row">
						...
						<div id="bar_icon">
							...
							<div class="w3-dropdown-hover w3-hide-small w3-hover-white">
								...
								<div class="w3-dropdown-content w3-card-4 w3-bar-block"
									...
									<a href="#" class="w3-bar-item w3-button">새로 업로드된 게시물이 개 있습니다.</a> 
									<a href="${pageContext.request.contextPath}/${member.ID}/messageList" class="w3-bar-item w3-button">
										읽지 않은 쪽지가 ${messageCount}개 있습니다.
									</a> 
									<a href="chat" class="w3-bar-item w3-button">채팅이 개 있습니다.</a>
								</div>
							</div>
							<%-- 새 글 알림 끝 --%>
						</div>
				...
				<c:choose>
					...
					<c:when test="${member.ID != null}">
						...
						<%-- 검색창 --%>
						<div class="col-md-2" align="right" style="padding: 0px; margin-top: 14px;">
			...
			<c:if test="${member.ID != null}">
			<div class="col-md-2" align="right" style="padding-right: 50px;">
