	...
	<div class="w3-bar w3-theme-d2 w3-left-align w3-large" id="bar">
		<div id="icon">
			<a
				...
				title="News"><i class="fa fa-globe" style="color: #B0F8EC"></i></a>
			<a href="chat"
				class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white"
				title="Chatting"><i class="fa fa-user" style="color: #A0EEEE"></i></a>
			<a href="multiChat"
				class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white"
				title="Chatting"><i class="fa fa-user" style="color: #A0EEEE"></i></a>
			<a href="messageList"
		...
		<div class="baby">
			<a href="${pageContext.request.contextPath}/main" class="w3-bar-item w3-button w3-padding-large w3-theme-d4"><img
				src="${pageContext.request.contextPath}/resources/css/logo2.png"
				height="50px" class="babylogo"></a>
		</div>
