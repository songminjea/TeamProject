  		 	...
  		 	<c:if test="${member.ID != null}">
	        	<div class="col-md-4" id="bar_left" align="left">
					 <div id="bar_icon">
					  ...
					  <a href="#" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white" title="Board"><i class="fa fa-list" id="board_i" aria-hidden="true"></i></a>
					  <a href="messageList" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white" title="Send Message"><i class="fa fa-envelope" id="message_i"></i></a>
					  <a href="#" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white" onclick="window.open('multiChat', 'multiChat', 'width=370, height=450')" title="Chat"><i class="fa fa-weixin" id="chat_i" aria-hidden="true"></i></a>
						<%-- 새 글 알림 --%>
						<div class="w3-dropdown-hover w3-hide-small">
					    	<button class="w3-button w3-padding-large" title="Notifications">
					    		<i class="fa fa-bell" id="alarm_i"></i>
					    		<span class="w3-badge w3-right w3-small" style="background-color: #cbcbcd;">3</span>
					    	</button>  
					   			<%-- 새 글 알림 드롭다운 --%>   
