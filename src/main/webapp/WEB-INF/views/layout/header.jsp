...
<div class="w3-dropdown-hover w3-hide-small">
  ...
  <h5 class="w3-bar-item w3-button w3-hide-small w3-right w3-padding-large w3-hover-white" ><a href="http://localhost:8080/TeamPro/logout">${member.NAME}님 환영합니다.</a></h5>
 </div>
</div>
