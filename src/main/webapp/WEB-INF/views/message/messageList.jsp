...
<script type="text/javascript">
	function messageViewOpen() {
		var MESSAGE_NO = ${message.MESSAGE_NO};
		window.open("messageView?MESSAGE_NO="+MESSAGE_NO, "messageView", "width=500, height=600");
	}
	function messageSendOpen() {
		window.name = "messageList"
          ...
          <div class="w3-card w3-round w3-white">
            <div class="w3-container w3-padding">
              <div align="center">
					...
					<c:forEach items="${mlist}" var="message">
					 	<c:if test="${member.ID eq message.MESSAGE_RECEIVER}">  
							<tr bgcolor="white">
								...
								<td>
									<a href="messageView?MESSAGE_NO=${message.MESSAGE_NO}" id="messageView" onclick="messageViewOpen();">${message.MESSAGE_SUBJECT}</a>
								</td>
				...
				<input type="button" class="btn" value="쪽지보내기" id="messageSend" onclick="messageSendOpen();">
				</div>
            </div>
          </div>
        </div>
